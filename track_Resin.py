...
# Resin_M4
args.model_file = '/media/hdd/experiments/2017-11-12-T16-siam-coarse-RNN_hglass-sc_net-Disable_ss-RESTORE_JADE/workspace/ckpt/iteration-180000'

args.vot = True
args.model = 'Nornn'
args.cnn_model= 'custom'
args.model_params = {"rnn":True,"rnn_hglass":True,"coarse_hmap":True,"sc":True,"sc_net":True}
args.vis = True
args.vis_dir = 'vis'
args.vis_keep_frames = True
args.gpu_frac = 0.8
